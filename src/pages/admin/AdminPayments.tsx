...
const mockPayments = [
  { id: "PAY-001", booking: "BK-20250001", customer: "Rafiq Ahmed", amount: "৳4,500", method: "bKash", date: "2025-03-15", status: "completed" },
  { id: "PAY-002", booking: "BK-20250002", customer: "Fatema Khatun", amount: "৳17,000", method: "Bank Transfer", date: "2025-03-16", status: "pending_verification" },
  { id: "PAY-003", booking: "BK-20250003", customer: "Kamal Hossain", amount: "৳32,000", method: "Visa Card", date: "2025-04-01", status: "completed" },
  { id: "PAY-004", booking: "BK-20250004", customer: "Nusrat Jahan", amount: "৳68,000", method: "Nagad", date: "2025-04-10", status: "pending" },
  { id: "PAY-005", booking: "BK-20250005", customer: "Sohel Rana", amount: "৳28,500", method: "Card", date: "2025-02-10", status: "refunded" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total Revenue", value: "৳12.4M", icon: DollarSign, color: "text-success" },
          { label: "This Month", value: "৳1.8M", icon: TrendingUp, color: "text-primary" },
          { label: "Pending", value: "৳85K", icon: Clock, color: "text-warning" },
          { label: "Needs Verification", value: "23", icon: AlertTriangle, color: "text-secondary" },
        ].map((s, i) => (
          <Card key={i}>
            ...
            <TableBody>
              {mockPayments.map((p) => (
                <TableRow key={p.id}>
                  ...
                  <TableCell>
                    <Badge variant="outline" className={`text-[10px] ${statusMap[p.status]?.class}`}>
