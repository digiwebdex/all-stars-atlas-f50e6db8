...
import { Star, MapPin, Wifi, Waves, Car, UtensilsCrossed, Heart, ArrowRight, CheckCircle2, Users } from "lucide-react";
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-1.5 mt-2">
                          {room.perks.map(p => <Badge key={p} variant="outline" className="text-[10px] font-medium">{p}</Badge>)}
                        </div>
                      </div>
          ...
          <Card className="sticky top-28">
            <CardContent className="p-5 space-y-4">
              <div className="text-center">
                <p className="text-xs text-muted-foreground line-through">৳11,000</p>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between"><span className="text-muted-foreground">Check-in</span><span className="font-semibold">Feb 27, 2026</span></div>
                <div className="flex justify-between"><span className="text-muted-foreground">Check-out</span><span className="font-semibold">Mar 1, 2026</span></div>
                <div className="flex justify-between"><span className="text-muted-foreground">Guests</span><span className="font-semibold">2 Adults</span></div>
                <div className="flex justify-between"><span className="text-muted-foreground">2 Nights</span><span className="font-bold">৳17,000</span></div>
              </div>
              <Button className="w-full h-11 font-bold shadow-lg shadow-primary/20" asChild>
                <Link to="/booking/confirmation">Reserve Now <ArrowRight className="w-4 h-4 ml-1" /></Link>
              </Button>
              <p className="text-[10px] text-center text-muted-foreground">Free cancellation before Feb 25</p>
            </CardContent>
          </Card>
        </div>
      </div>
