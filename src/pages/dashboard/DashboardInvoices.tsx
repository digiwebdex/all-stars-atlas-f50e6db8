...
import { Search, FileText, Download, Eye, Printer, Receiptlucide-react";
...
import { generateInvoicePDF, printI, generatnvoicePDF, generateMoneyReceiptm "@/lib/pdf-generator";
